...
export const RECEIVE_RATINGS = 'receive_ratings' // 接收商家评
...
export const RECEIVE_SEARCH_SHOPS = 'receive_search_shop' //接收搜索的商家
